...
case 'dare': case 'حكم':
    ...
    "روح اشتم التحالف الي انت فيه برسالة جماعية وبعت اسكرين",
	"اعمل اي طلب يقلك عليه صاحب البوت اختياري 🙂❤",
    "اطلع  وانزل من الدور الاءرضي عندك  للسطح فوق وهات فديو ❤",
    "روح قول لل اكس احلقي شنبك 🌚❤",
    "قول شعر ل شخص ال بتلعب معا 😍💗!",
    "اكتب عندك ف بايو اسم شخص بتحبو 🌚❤",
    "اكتب كلمه جدو و حط صوره ال هتجيلك بروفايل +اجباري 😂❤",
    "قول نكته ف ريك بس تكون حلوه عشان لو وحشه هتخد حكم اسواء 🙂❤",
    "استغفر ربنا 100 مع ريكورد 😜❤",
...
( اعدادات جروب) تمام ال اوامر ال فيها مسافه انا بكتبها ب مسافه لاكن لما تيجي تبعت امر زي اعدادات جروب اكتبو من غير مسافه زي (اعداداتجروب) بس كد لو ف حاجه وقفت 
(الاءلعاب) 
اكتب اكسo عشان تلعب اكس اوه عايز تلغي اكتب🦄🦄 بس كده يحبي 
 اكتب لعبه2 عشان تلعب حجره ورقه مقص اعمل العلامه دي @ بعد متكتب لعبه2 واختار الي هتتحدي ياحب ملاحظة حجره ورقه مقص رومات فقط`
let buttons = [
...
break
case 'alive': case 'منيو': case 'list': case 'menu': case 'help': case 'قاءمه': {
		if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
